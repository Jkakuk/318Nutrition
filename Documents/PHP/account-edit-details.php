...
if (isset($_POST["submit"])) 
{
  ...
  $destination = '../../ProgramPlan/' . $filename;
  ...
  {
      echo "You file extension must be .txt, .pdf or .doc";
  } 
   else 
   {
      ...
      {
          $sql = "UPDATE Accounts SET NutritionPlan='$filename' WHERE ACC_ID='$cacheID'";
...
<body>
  ...
  <div class="second-navbar">
    <div class="second-navbar-links">
      <ul>
  <li><a href="../../Documents/PHP/view-accounts.php"><span class="fa fa-arrow-left" aria-hidden="true"><p>BACK</p></a></li>
  ...
  <body>
    <!-- Data Table -->
          ...
          <td<?php echo $column == "Phone"? $add_class : ""; ?>><?php echo $row["Phone"]; ?></td>
					...
					<td<?php echo $column == "Nutrition Plan"; ?>><a href='../../ProgramPlan/<?php echo $row["NutritionPlan"]; ?>'><?php echo $row["NutritionPlan"]; ?></a></td>
      ...
      <form action="<?php echo htmlspecialchars(
        $_SERVER["PHP_SELF"] 
            ...
            <div class="form-group">
                ...
                <input type="reset" class="btn btn-primary ml-2" value="Clear">&nbsp;
								<a href="../PHP/reset-password.php" class="btn btn-primary">Change Password</a>&nbsp;
								<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are you sure you want to delete this Account?');" href="../PHP/remove-user.php" class="btn btn-primary">Delete Account</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php 

                if($active == 0)
                {
                  echo '<input type="submit" name="Activate" class="btn btn-primary" value="Activate">&nbsp;';
                }
                if($active == 1)
                {
                  echo '<input type="submit" name="Deactivate" class="btn btn-primary" value="Deactivate">&nbsp;';
                }
                ?>
