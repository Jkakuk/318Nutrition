...
if(isset($_POST['submit']))
{
    ...
    { 
      $result = $link->query("INSERT INTO Journal (ACC_ID, J_EntryData, J_MealsEaten, J_Weight, J_EnergyLevel, J_ExericeNotes, J_Reviewed) VALUES ('$id', '$entrydate', '$energylevel', '$weight', '$meals', '$notes', '$zero')");
...
?> 
  ...
  <li id=""><a href="../../ProgramPlan/<?php echo $plan; ?>"><span class="fa fa-file-pdf" aria-hidden="true"><p>VIEW PLAN<p></a></li>
</ul>
  </div>
  </div>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="energylevel" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Current Weight</label>
                <input type="number" name="weight" class="form-control" placeholder="pounds" required >
            </div>
            <div class="form-group">
                <label>Meal had today</label>
                <input type="number" name="meals" class="form-control" required>
            </div>
            <div class="form-group">
